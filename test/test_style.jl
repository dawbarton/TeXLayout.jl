...
@testset "TeX style cascade" begin
    ...
    @testset "Enum membership" begin
        all_styles = (Display, CrampedDisplay, Text, CrampedText,
    ...
    @testset "size_scale (NewCMMath-Regular)" begin
        ...
        @test size_scale(Script,              mc) ≈ 0.70
        @test size_scale(CrampedScript,       mc) ≈ 0.70
        @test size_scale(ScriptScript,        mc) ≈ 0.50
        @test size_scale(CrampedScriptScript, mc) ≈ 0.50
    end
